...
export class Backend implements backendInterface {
    ...
    async getPromptHistory(): Promise<Array<PromptHistory>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPromptHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSituationBehaviors(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSituationBehaviors();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async savePreset(arg0: string, arg1: PoseCriteria): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async sendQueries(arg0: PoseCriteria, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.sendQueries(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
